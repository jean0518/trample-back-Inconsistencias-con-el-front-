...
func (r *OwnerRepository) Create(ctx context.Context, input owner.CreateInput) (owner.Owner, error) {
	...
	err := r.db.QueryRow(ctx, `
		...
		VALUES ($1, $2, $3, $4)
		RETURNING id, name, phone, email, is_default, created_at, updated_at
	`, input.Name, input.Phone, input.Email, input.IsDefault,
	).Scan(&o.ID, &o.Name, &o.Phone, &o.Email, &o.IsDefault, &o.CreatedAt, &o.UpdatedAt)
	if err != nil {
...
func (r *OwnerRepository) ListAll(ctx context.Context) ([]owner.Owner, error) {
	...
	for rows.Next() {
		var o owner.Owner
		if err := rows.Scan(&o.ID, &o.Name, &o.Phone, &o.Email, &o.IsDefault, &o.CreatedAt, &o.UpdatedAt); err != nil {
...
func (r *OwnerRepository) FindByID(ctx context.Context, id int64) (owner.Owner, error) {
	var o owner.Owner
	err := r.db.QueryRow(ctx, `
		SELECT id, name, phone, email, is_default, created_at, updated_at
	...
	if err != nil {
		...
		return owner.Owner{}, fmt.Errorf("buscar owner %d: %w", id, err)
	}
	return o, nil
}
